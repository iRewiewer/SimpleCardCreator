...
void main() async {
  ...
  windowManager.waitUntilReadyToShow().then((_) async {
    await windowManager.setSize(const Size(900, 820));
    await windowManager.setMaximumSize(const Size(900, 820));
    await windowManager.setMinimumSize(const Size(900, 820));
